    ...
    <body>
        ...
        <section style="padding: 20px; background-image: url('https://saas.diga.pt/img/mail_background.png'); background-size: cover;">
            <div style="margin: 0 auto; width: 700px; background-color: #FFFFFF; padding: 20px;">
                <h2 style="text-align: center;">{{trans('template.Dear_customer', [], $locale).$service_referrer->name.'!' }}</h2>
                <div style="border: 1px solid #000000;"></div>
                <h4>{{trans('template.Unread_messages_from', [], $locale).$user_name_from}}</h4>
                ...
                mso-hide:all;" href="{{env('APP_URL').'/access/'.$token}}">{{trans('template.Go_to_dialog', [], $locale)}}</a>
                </div>
            </div>
        </section>
        <footer>
